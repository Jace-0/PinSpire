...
router.post('/:id/comment', authentication, sanitization,  pinController.createComment )
router.post('/:id/like', authentication, sanitization, pinController.likePin )
// router.post('/comments/:commentId/replies', authentication, sanitization, pinController.replyToComment)
// router.post('/comments/:commentId/replies/:replyId', authentication, sanitization, pinController.replyToReply)
